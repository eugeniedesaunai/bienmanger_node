...
function generateToken() {
    ...
    return (0, jsonwebtoken_1.sign)(payload, { key: privateKey, passphrase: 'stan' }, signInOptions);
}
...
/* export function validateToken(token: string): Promise<TokenPayload> {
    ...
    return new Promise((resolve, reject) => {
        verify(token, { key: privateKey, passphrase: 'stan' }, verifyOptions, (error: any, decoded: TokenPayload) => {
